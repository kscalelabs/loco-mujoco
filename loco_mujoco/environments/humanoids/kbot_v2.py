...
class KBotV2(BaseRobotHumanoid):
    ...
    def sites_for_mimic(self) -> List[str]:
        ...
        """
        return ["pelvis_mimic", "upper_body_mimic", "head_mimic",
                "left_shoulder_mimic", "left_elbow_mimic", "left_wrist_mimic",
                "left_hip_mimic", "left_knee_mimic", "left_ankle_mimic", "left_foot",
                "right_shoulder_mimic", "right_elbow_mimic", "right_wrist_mimic",
                "right_hip_mimic", "right_knee_mimic", "right_ankle_mimic", "right_foot"]
