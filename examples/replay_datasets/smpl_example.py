...
def experiment(seed=0):
    ...
    env = ImitationFactory.make(
        ...
        amass_dataset_conf=AMASSDatasetConf(
            [
                "ACCAD/ACCAD/Male1Walking_c3d/Walk B13 - Walk turn right 45_poses",
                "ACCAD/ACCAD/Male2Running_c3d/C1 - stand to run_poses",
                "ACCAD/ACCAD/s001/EricCamper04_poses.npz",
            ]
        ),
    ...
    # env.play_trajectory(n_episodes=1, n_steps_per_episode=500, render=True, record=True)
